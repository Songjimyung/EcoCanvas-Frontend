    ...
    <div className='topbar'>
      <div className='topbarWrapper'>
        <div className='topLeft'>
          <Link to='/admin_home' className='_signBtn'><span className='logo'>Admin</span></Link>
        </div>
        <div className='topRight'>
          ...
          &nbsp;|&nbsp;
          {isLoggedIn ? (
            <select className="category-dropdown" onChange={handleLinkBySelect} style={{ marginLeft: '5px' }}>
